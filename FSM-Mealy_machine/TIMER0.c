...
void Timer0_NormalMode_init(uint8_t prescaler_select)
{
...
void Timer0_CTC_init(uint8_t OC , uint8_t prescaler_select)
{	
	//activate force output compare
	SET_BIT(TCCR0,FOC0);
...
void Timer0_FreqGene(uint8_t OC , uint8_t prescaler_select)
{
	//activate force output compare
	SET_BIT(TCCR0,FOC0);
	//set timer0 to CTC mode
